...
const Home = () => {
  ...
  return (
    ...
    >
      {/* ====================== SCROLLING TEXT ======================== */}
      <div className="w-full py-2.5 font-medium text-sm text-white bg-linear-to-r from-green-400 via-green-500 to-green-600 overflow-hidden font-roboto">
        <motion.div
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex justify-center items-center py-12 md:py-24">
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                <h1 className="font-lobster text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-3">
                  100% Healthy & Tasty
                </h1>

                <h2 className="font-merriweather text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold text-green-400 mb-6">
                  ORGANIC FOOD
                </h2>
              </motion.div>
              ...
              <motion.p
                ...
                className="font-roboto text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed mb-10"
              >
              ...
              >
                <Link
                  to="/products"
                  className="px-8 sm:px-10 py-3 sm:py-4 bg-green-500 hover:bg-green-600 text-white font-roboto font-bold text-lg sm:text-xl rounded-full shadow-xl transition-all transform hover:scale-105"
                >
                  Shop Now
                </Link>
              </motion.div>
      ...
      {/* ====================== STATS SECTION ======================== */}
      <section className="bg-green-600 text-white py-14 sm:py-16 font-roboto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            {[
              ...
              <motion.div
                ...
                className="space-y-2"
              >
                <p className="font-lobster text-2xl sm:text-3xl md:text-5xl font-bold">
                  {stat.value}
                </p>
                <p className="font-roboto text-sm sm:text-lg opacity-90 font-medium">
                  {stat.label}
                </p>
              </motion.div>
            ))}
      ...
      <section
        id="products"
        className="py-12 sm:py-20 md:py-24 bg-white font-roboto"
      >
        <div className="container mx-auto">
          ...
          >
            <h2 className="font-merriweather text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">
              Our Best Sellers
            </h2>
          ...
          >
            <Link
              to="/products"
              className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-green-600 hover:bg-green-700 text-white font-roboto font-semibold rounded-lg shadow-md hover:shadow-xl transition-all transform hover:-translate-y-1"
            >
              View All Products
            </Link>
          </motion.div>
      ...
      {/* ====================== WHY CHOOSE US ======================== */}
      <section className="mt-8 py-12 sm:py-20 bg-gray-50 font-roboto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            {[
              ...
              >
                ...
                <h3 className="font-merriweather text-xl sm:text-2xl font-bold text-gray-900 mb-3">
                  {item.title}
                </h3>
