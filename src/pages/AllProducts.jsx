...
const AllProducts = () => {
  ...
  return (
    <div className="pb-14 sm:pb-16 md:pb-20 bg-white font-roboto">
              ...
              {categoryOrder.map((category) => (
                <li key={category}>
                  <button
                    ...
                    className="block w-full text-left px-3 py-2 rounded-lg text-gray-700 hover:bg-green-100 hover:text-green-700 transition-colors duration-200 font-roboto"
                  >
                    {category}
                  </button>
                </li>
        ...
        <div className="lg:w-3/4">
          <div className="text-center mb-6 sm:mb-12">
            <motion.h1
              ...
              className="font-lobster text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 leading-snug"
            >
            ...
            <motion.p
              ...
              className="text-gray-600 mt-4 text-sm sm:text-base max-w-2xl mx-auto px-2 font-roboto"
            >
          ...
          {categoryOrder.map((category) => {
            ...
            return (
              ...
              >
                <h2 className="text-4xl font-merriweather font-extrabold text-gray-900 mb-8 text-center relative">
                ...
                {category === "Bundles" && (
                  <>
                    ...
                    <p className="text-center text-md text-gray-600 mb-8 max-w-3xl mx-auto font-roboto">
